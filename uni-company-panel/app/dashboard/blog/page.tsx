...
import { DataTable } from '@/components/common/TableData'; // Using your shared component
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
...
const BlogsPage = () => {
  ...
  // Note: Ensure your store updates these values from res.data.blogs and res.data.paginator
  const {
    blogListData, // This should be res.data.blogs
    blogPaginator, // This should be res.data.paginator
    getBlogList,
    deleteBlog,
    bulkDeleteBlogs,
    isLoading,
  ...
  useEffect(() => {
    getBlogList(10, currentPage, searchQuery, {
      publishStatus: currentStatus || undefined,
    });
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      {/* Stats Cards mapped to your publishStatus backend logic */}
        ...
        <StatCard
          ...
          value={
            blogListData?.filter((b: any) => b.publishStatus === 'published')
              .length || 0
          } // Ideally your backend returns these counts
