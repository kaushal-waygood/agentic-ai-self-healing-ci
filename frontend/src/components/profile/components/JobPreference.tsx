...
//                 </label>
//                 <textarea
//                   className="w-full p-4 rounded-lg border-2 border-slate-200 dark:border-slate-600 bg-white focus:border-blue-400 dark:bg-slate-800 outline-blue-400  transition-all duration-300 resize-none"
//                   rows={3}
...
//                 </label>
//                 <textarea
//                   className="w-full p-4 rounded-lg border-2 border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-800  outline-blue-400 transition-all duration-300 resize-none"
//                   rows={3}
...
//         <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-lg shadow-2xl shadow-purple-400/10 border border-white/20 p-3 sm:p-6 md:p-2">
...
//                     className="w-full sm:w-auto px-6 sm:px-8 py-2 sm:py-3 bg-buttonPrimary text-white rounded-lg font-semibold shadow-lg shadow-blue-400/30 hover:shadow-xl hover:shadow-blue-400/40 transform hover:scale-105 transition-all duration-300"
//                   >
//                     Next
//                   </button>
//                 )}
...
//                     className="w-full sm:w-auto px-6 sm:px-8 py-2 sm:py-3 bg-buttonPrimary text-white rounded-lg font-semibold shadow-lg shadow-purple-400/30 hover:shadow-xl hover:shadow-purple-400/40 transform hover:scale-105 transition-all duration-300"
//                   >
//                     Save
//                   </button>
//                 )}
...
//         <button
//           onClick={handleSavePreferences}
//           className="px-8 py-3 bg-buttonPrimary text-white rounded-lg font-semibold"
//         >
//           Save
//         </button>
//       </div>
