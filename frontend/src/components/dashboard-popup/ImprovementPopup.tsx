...
export default function ImprovementPopup({
  ...
  // 2. Ensure we only render on the client to avoid SSR mismatch
  useEffect(() => {
    setMounted(true);
          ...
          {showCalendar ? (
            ...
            <>
              ...
              <textarea
                ...
                className="w-full h-32 p-3 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-purple-500 outline-none resize-none mb-4"
              />
  ...
  // 4. Use createPortal to inject this into the body
