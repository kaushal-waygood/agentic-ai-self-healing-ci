                                    ...
                                    <>
                                      {loading ? (
                                        <div className="flex flex-col items-center justify-center py-10 text-slate-500">
                                          ...
                                          <p>Fetching saved Cover Letters...</p>
                                        </div>
                                      ) : (
                                        <div>
...
//                     {/* LEFT COLUMN - Skip + Paste */}
//                     <div className="space-y-4">
//                       {options
//                         .filter(
//                           (option) =>
//                             option.value === 'skip' || option.value === 'paste',
//                         )
//                         .map((option, index) => {
//                           const Icon = option.icon;
//                           const isSelected = field.value === option.value;
...
//                     {/* RIGHT COLUMN - Saved CL */}
//                     <div>
//                       {options
//                         .filter((option) => option.value === 'saved')
//                         .map((option, index) => {
//                           const Icon = option.icon;
//                           const isSelected = field.value === option.value;
//                           return (
...
//                                 {isSelected && (
//                                   <div className="max-h-[35vh] overflow-y-auto border border-violet-300 rounded-lg bg-white p-2 mt-6">
//                                     <FormField
//                                       control={clForm.control}
//                                       name="savedClId"
//                                       render={({ field: savedField }) => (
