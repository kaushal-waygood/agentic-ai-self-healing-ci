                ...
                <div className="flex shrink-0 items-center gap-3 rounded-xl border border-emerald-200 bg-emerald-50 p-3 shadow-sm">
                  ...
                  <div>
                    ...
                    <p className="text-[11.5px] font-medium leading-tight text-slate-600">
                      ...
                      CV based on industry standards.
                    </p>
                  </div>
                </div>
                ...
                {loading ? (
                  ...
                  <div className="flex flex-1 flex-col items-center justify-center text-center py-10">
                    <div className="relative mb-6 inline-block">
                      ...
                      <div className="relative z-10 flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 shadow-2xl transition-transform duration-300 hover:scale-110">
                        <Briefcase
                    ...
                    <p className="mx-auto max-w-sm text-[13.5px] font-medium leading-relaxed text-slate-500">
                      ...
                      they'll appear here for instant CV generation.
                    </p>
                  </div>
                )}
              </TabsContent>
              ...
              >
                <div className="flex flex-col gap-4 md:flex-row md:items-center">
                  <div className="relative flex-1">
                    <div className="absolute left-4 top-1/2 flex -translate-y-1/2 items-center rounded-lg bg-blue-50 p-1.5 text-blue-600">
                    ...
                    <input
                      ...
                      value={enteredJobTitle}
                      onChange={(e) => setEnteredJobTitle(e.target.value)}
                      className="w-full rounded-xl border border-slate-200 bg-slate-50 py-4 pl-14 pr-4 text-[14px] font-bold text-slate-900 shadow-sm transition-all placeholder:font-medium placeholder:text-slate-400 focus:border-blue-400 focus:bg-white focus:outline-none focus:ring-4 focus:ring-blue-50"
                    />
                  </div>
                </div>
                ...
                <div className="flex shrink-0 items-start gap-3 rounded-xl border border-emerald-200 bg-emerald-50 p-4 shadow-sm">
                  ...
                  <div>
                    ...
                    <p className="text-[12px] font-medium leading-relaxed text-slate-600">
                      ...
                      optimize your CV based on common industry requirements and
