...
const CVGeneratorClient = ({
  ...
  // Unused but kept if needed for future expansion matching original code
  const [expandedCv, setExpandedCv] = useState(null);
    ...
    <div className="flex flex-1 flex-col overflow-hidden p-4 md:p-6 font-jakarta antialiased">
      ...
      <div className="mx-auto flex h-full w-full  flex-col">
        ...
        <div className="flex min-h-0 flex-1 flex-col overflow-hidden rounded-[20px] border border-slate-200 bg-white shadow-sm">
          ...
          {/* Content Area */}
          <div className="custom-scrollbar flex min-h-0 flex-1 flex-col gap-4 overflow-y-auto p-6 animate-in fade-in duration-500">
            ...
            <div className="shrink-0 space-y-3">
              {loading ? (
                ...
                <p className="p-4 text-center text-sm font-medium text-slate-500">
