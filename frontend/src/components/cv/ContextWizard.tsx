...
const ContextWizard = ({
  ...
  const toggleSuggestion = (suggestion: any) => {
    ...
    setAdditionalNarratives((currentNarratives: string) => {
      if (isCurrentlySelected) {
        let newText = currentNarratives.replace(suggestionTextWithPeriod, '');
      ...
      <div className="mx-auto flex h-full w-full  flex-col">
        ...
        <div className="flex min-h-0 flex-1 flex-col overflow-hidden rounded-[20px] border border-slate-200 bg-white shadow-sm animate-in fade-in duration-500">
          ...
          <div className="flex shrink-0 items-center gap-3 border-b border-slate-100 px-6 py-4">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-purple-50 text-purple-600 shadow-sm">
            ...
            <div>
              ...
              <p className="text-[12px] font-medium text-slate-500">
                Add your personal touch to make your CV stand out.
              </p>
            </div>
          </div>
          ...
          <div className="custom-scrollbar flex min-h-0 flex-1 flex-col overflow-y-auto p-6 gap-6">
            ...
            <div className="shrink-0">
              <div className="flex items-center justify-between mb-3">
                ...
                {selectedSuggestions.length > 0 && (
                  <span className="text-[10px] font-extrabold uppercase tracking-widest text-blue-600 bg-blue-50 px-2 py-0.5 rounded border border-blue-100">
            ...
            <div className="flex min-h-[160px] flex-1 flex-col">
              <h3 className="mb-2 flex items-center gap-2 text-[13px] font-extrabold text-slate-900">
                <Wand2 className="h-4 w-4 text-blue-500" strokeWidth={2.5} />
                Custom Instructions
              ...
              <textarea
                placeholder="Tell us what to emphasize... e.g. Highlight my cross-functional team experience and track record of driving revenue growth."
                className="custom-scrollbar w-full flex-1 resize-none rounded-xl border border-slate-200 bg-slate-50 p-4 text-[13.5px] font-medium text-slate-900 shadow-inner transition-all placeholder:text-slate-400 focus:border-blue-400 focus:outline-none focus:ring-4 focus:ring-blue-50"
                value={additionalNarratives}
                onChange={(e) => setAdditionalNarratives(e.target.value)}
              ></textarea>
            </div>
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 shrink-0">
              <div className="flex items-center gap-2.5 rounded-xl border border-blue-100 bg-blue-50/50 p-3 shadow-sm">
                <Target
                  className="h-4 w-4 shrink-0 text-blue-500"
                  strokeWidth={2.5}
                />
                <p className="text-[11.5px] font-medium leading-tight text-slate-700">
                  <span className="font-extrabold text-slate-900">
                    Pro tip:
                  </span>{' '}
                  Be specific about achievements and technologies used.
                </p>
              </div>
              <div className="flex items-center gap-2.5 rounded-xl border border-emerald-100 bg-emerald-50/50 p-3 shadow-sm">
                <TrendingUp
                ...
                <p className="text-[11.5px] font-medium leading-tight text-slate-700">
                  ...
                  Quantifiable results and direct business impact.
                </p>
              </div>
            </div>
          </div>
