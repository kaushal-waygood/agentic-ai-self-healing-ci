...
export function JobSearchFilters() {
  ...
  function onSubmit(data: JobSearchFlowInput) {
    ...
    data.employmentTypes?.forEach(type => params.append('employmentTypes', type));
    data.jobRequirements?.forEach(req => params.append('jobRequirements', req));
  ...
  return (
    <Card>
      <CardHeader><CardTitle>Search for Jobs</CardTitle></CardHeader>
      <CardContent>
        <Form {...form}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="e.g., software engineer in san francisco" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    ...
                    <SelectContent>
                      {countries.map(c => <SelectItem key={c.code} value={c.code.toLowerCase()}>{c.name}</SelectItem>)}
                    </SelectContent>
                  </Select>
                  <FormMessage />
                </FormItem>
