      ...
      <div className="rounded-xl border border-white/20 p-1">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-4 px-4 sm:px-6">
          ...
          <div className="flex items-center justify-center md:justify-start">
            {job.logo ? (
              <div className="w-12 h-12 relative rounded-xl overflow-hidden shadow-lg ring-4 ring-purple-100/50">
                <Image
                  src={job.logo}
              ...
              <div className="w-12 h-12 relative rounded-xl flex items-center justify-center bg-gradient-to-br from-purple-100 via-blue-100 to-cyan-100 shadow-lg ring-4 ring-purple-100/50">
                <Image
                  src="/logo.png"
                  alt={job.company || 'Company Logo'}
                  fill
