...
// Moved outside to prevent re-allocation
const STATS = [
  { number: '500K+', label: 'Applications Sent', icon: Target },
  { number: '15K+', label: 'Jobs Landed', icon: TrendingUp },
  { number: '98%', label: 'Success Rate', icon: CheckCircle },
...
export const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
      {/* Static Background Effects (Transitions Removed) */}
      {/* <div className="absolute inset-0 z-0 pointer-events-none">
        <div className="absolute w-[500px] h-[500px] bg-gradient-to-br from-purple-400/20 to-blue-500/20 rounded-full blur-3xl animate-pulse left-[15%] top-[5%] -translate-x-1/2 -translate-y-1/2" />
        <div
          className="absolute w-[400px] h-[400px] bg-gradient-to-br from-cyan-400/15 to-purple-500/15 rounded-full blur-3xl animate-pulse right-[10%] bottom-[10%] translate-x-1/2 translate-y-1/2"
