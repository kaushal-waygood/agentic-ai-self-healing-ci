...
export function Pricing() {
  ...
  return (
    <section className="relative py-20">
      ...
      >
        <div className="relative bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 rounded-3xl p-8 shadow-2xl overflow-hidden group hover:scale-[1.02] transition-all duration-500">
          {/* Animated background elements */}
          <div className="absolute top-0 left-0 w-full h-full">
            <div className="absolute top-10 left-10 w-32 h-32 bg-blue-400/10 rounded-full blur-2xl animate-pulse" />
            <div
              className="absolute bottom-10 right-10 w-24 h-24 bg-purple-400/10 rounded-full blur-2xl animate-pulse"
              style={{ animationDelay: '1s' }}
            />
          </div>
          ...
          <div className="relative z-10 text-center">
            ...
            <p className="text-xl text-gray-300 leading-relaxed max-w-2xl mx-auto mb-8">
              Not satisfied with your results? Get a{' '}
              <span className="text-emerald-400 font-semibold">
                full refund
              </span>{' '}
              within 30 days, no questions asked. We're confident ZobsAI will
