...
const initialFooterData: FooterData = {
  company: {
    name: 'Zobsai',
    tagline:
      'Your trusted partner in navigating the path to your dream career.',
  ...
  socials: {
    ...
    description: 'Follow us on social media for the latest updates and tips.',
    links: [
      { name: 'Facebook', href: '#' },
      { name: 'Twitter', href: '#' },
      { name: 'Instagram', href: '#' },
  ...
  copyright: `© ${new Date().getFullYear()} Zobsai. All Rights Reserved.`,
};
