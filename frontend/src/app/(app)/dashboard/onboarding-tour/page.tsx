      ...
      <div className="min-h-screen flex items-center justify-center p-4">
        <Card className="w-full max-w-lg p-8 md:p-10 text-center shadow-2xl bg-white/70 backdrop-blur-xl animate-[fadeIn_0.5s_ease-out]">
          ...
          {/* <div className="space-y-4">
            <label className="block w-full text-left p-6 rounded-lg border-2  hover:border-purple-500 cursor-pointer transition-all duration-300 transform hover:-translate-y-1">
            ...
            <Button
              ...
              className="w-full text-left p-6 rounded-lg border-2 hover:border-blue-500 transition-all duration-300 transform hover:-translate-y-1 h-auto"
              variant="outline"
            >
              <div className="flex items-center">
          ...
          <div className="space-y-4">
            {/* Auto-fill with Resume */}
            <label
              className="block text-left w-full cursor-pointer rounded-lg border-2 
      bg-white p-6 transition-all duration-300 hover:border-blue-400
       hover:-translate-y-1"
            >
              <div className="flex items-center">
            ...
            <button
              ...
              // variant="outline"
              className="w-full h-auto p-6 text-left rounded-lg border-2 border-gray-200 
                ...
                {[...Array(totalSteps)].map((_, i) => (
                  <div
                    ...
                    className={`transition-all duration-500 ${
                      i + 1 === step
                        ? 'w-10 h-2.5 bg-blue-400 rounded-full shadow-lg'
                        : i + 1 < step
                        ? 'w-2.5 h-2.5 bg-blue-400 rounded-full'
