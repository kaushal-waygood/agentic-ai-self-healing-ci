        ...
        <main className="max-w-4xl mx-auto bg-white/70 backdrop-blur-lg rounded-3xl p-8 md:p-12 border border-gray-200 shadow-xl">
          ...
          >
            <p>
              ...
              Service in any way that could damage the Service, the business of
              [Your Company Name], or any user.
            </p>
            <ul className="space-y-3 mt-4">
              ...
              <li className="flex items-start">
                <XCircle className="w-5 h-5 text-rose-500 mr-3 mt-1 flex-shrink-0" />
                <span>
                  You may not violate any intellectual property rights of [Your
                  Company Name] or any third party.
                </span>
              </li>
              <li className="flex items-start">
                <XCircle className="w-5 h-5 text-rose-500 mr-3 mt-1 flex-shrink-0" />
