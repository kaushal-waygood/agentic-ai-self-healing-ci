        ...
        <main className="max-w-4xl mx-auto bg-white/70 backdrop-blur-lg rounded-3xl p-8 md:p-12 border border-gray-200 shadow-xl">
          ...
          >
            <p>
              ...
              operation of our services. We store personal information for only
              as long as we have a reason to keep it. We aim for full
          ...
          >
            <p>
              ...
              so—for example, to provide our Services, to communicate with you,
              or to make our Services better. We collect this information from
              three sources: if and when you provide information to us,
            ...
            <ul className="space-y-3 mt-4">
              <li className="flex items-start">
                ...
                <span>
                  ...
                  example, we require individuals who sign up for an account to
          ...
          >
            <p>
              ...
              and improve the effectiveness of our marketing, and to protect our
          ...
          >
            <p>
              ...
              such as monitoring our Services for potential vulnerabilities and
              attacks.
            </p>
          </PolicySection>
          ...
          >
            <p>
              ...
              about you: You can limit the information that you provide. You can
              access and update your information through your account settings.
              You have the right to deactivate your account. You can also opt
              out of our marketing communications at any time.
            </p>
          </PolicySection>
          ...
          >
            <p>
              ...
              Your continued use of the Services after any change in this
